...
function Register()
{
	...
	return(
		<div className="flex justify-center items-center">
			...
			<form className="z-[60] relative rounded-md px-12 pt-12 pb-8" onSubmit={doRegister}>
                {/* First Name */}
                <div className="mb-2">
                    <label className="block w-max text-white text-sm font-TWGsb">First Name</label>
                    <input className="w-72 h-10 rounded-3xl py-2 px-3 bg-gray-200 border border-black appearance-none" type="text" id="firstName" ref={ (c) => firstName = c} /><br />
                </div>
                {/* Last Name */}
                <div className="mb-2">
                    <label className="block w-max text-white text-sm font-TWGsb">Last Name</label>
                    <input className="w-72 h-10 rounded-3xl py-2 px-3 bg-gray-200 border border-black appearance-none" type="text" id="lastName" ref={ (c) => lastName = c} /><br />
                </div>
                {/* Email  */}
                <div className="mb-2">
                    <label className="block w-max text-white text-sm font-TWGsb">Email</label>
                    <input className="w-72 h-10 rounded-3xl py-2 px-3 bg-gray-200 border border-black appearance-none" type="email" id="email" ref={ (c) => email = c} /><br />
                </div>
                {/* Username */}
                <div className="mb-2">
                ...
                <div className="mb-2 flex justify-center">
                    <input className=" w-32 h-10 bg-white hover:bg-gray-50 rounded-3xl underline cursor-pointer text-sm font-TWGsb" type="submit" id="loginButton" value="Register" onClick={doRegister} />
                </div>
                {/* Login to existing account subtext */}
                <div className="mb-2 flex justify-center">
                    <label className="pr-2 text-white text-xs font-TWGr">Already have an account?</label>
                    <label className="underline cursor-pointer text-white text-xs font-TWGr" onClick={RedirectToLogin}>Login</label>
                </div>
                {/* Error message */}
