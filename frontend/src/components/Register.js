...
function Register()
{
	...
	return(
		<div class="tw-flex tw-justify-center tw-items-center">
			<div class="tw-z-[60] tw-absolute tw-w-[384px] tw-h-[667px] tw-border-2 tw-border-white tw-rounded-md tw-px-12 tw-pt-8 tw-pb-8 max-sm:tw-border-none"></div>
			<form class="tw-z-[60] tw-relative tw-rounded-md tw-px-12 tw-pt-12 tw-pb-8" onSubmit={doRegister}>
                {/* First Name */}
                <div class="tw-mb-2">
                    <label class="tw-block tw-w-max tw-text-white tw-text-sm tw-font-TWGsb">First Name</label>
                    <input class="tw-w-72 tw-h-10 tw-rounded-3xl tw-pt-1 tw-px-3 tw-bg-gray-200 tw-border tw-border-black tw-appearance-none tw-placeholder-gray-300 tw-font-TWGsb tw-text-sm tw-text-black" type="text" id="firstName" placeholder="Your first name..." ref={ (c) => firstName = c} /><br />
                </div>
                {/* Last Name */}
                <div class="tw-mb-2">
                    <label class="tw-block tw-w-max tw-text-white tw-text-sm tw-font-TWGsb">Last Name</label>
                    <input class="tw-w-72 tw-h-10 tw-rounded-3xl tw-pt-1 tw-px-3 tw-bg-gray-200 tw-border tw-border-black tw-appearance-none tw-placeholder-gray-300 tw-font-TWGsb tw-text-sm tw-text-black" type="text" id="lastName" placeholder="Your last name..." ref={ (c) => lastName = c} /><br />
                </div>
                {/* Email  */}
                <div class="tw-mb-2">
                ...
                <div class="tw-mb-3 tw-flex tw-justify-center">
                    <input class=" tw-w-32 tw-h-10 tw-bg-white hover:tw-bg-gray-50 tw-rounded-3xl tw-underline tw-cursor-pointer tw-text-sm tw-font-TWGsb" type="submit" id="loginButton" value="Register" onClick={doRegister} />
                </div>
                {/* Login to existing account subtext */}
                <div class="tw-mb-2 tw-flex tw-justify-center">
                    <label class="tw-pr-2 tw-text-white tw-text-xs tw-font-TWGr">Already have an account?</label>
                    <label class="tw-underline tw-cursor-pointer tw-text-white tw-text-xs tw-font-TWGr" onClick={RedirectToLogin}>Login</label>
                </div>
                {/* Error message */}
                <div class="tw-absolute tw-text-red">
